...
public class LevelConfigurationReader {
    ...
    private static final int SCALING_TIME_FACTOR = 34;
    ...
    public Map<GhostMode, Integer> getGhostModeLengths() {
        ...
        ghostModeLengths.put(GhostMode.CHASE, ((Number) modeLengthsObject.get("chase")).intValue() * SCALING_TIME_FACTOR);
        ghostModeLengths.put(GhostMode.SCATTER, ((Number) modeLengthsObject.get("scatter")).intValue() * SCALING_TIME_FACTOR);
        ghostModeLengths.put(GhostMode.FRIGHTENED, ((Number) modeLengthsObject.get("frightened")).intValue() * SCALING_TIME_FACTOR);
