...
import pacman.model.factories.ghostfactories.BlinkyFactory;
import pacman.model.factories.ghostfactories.ClydeFactory;
import pacman.model.factories.ghostfactories.InkyFactory;
import pacman.model.factories.ghostfactories.PinkyFactory;
...
public class GameEngineImpl implements GameEngine {
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        renderableFactoryRegistry.registerFactory(RenderableType.BLINKY, new BlinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.INKY, new InkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.CLYDE, new ClydeFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.PINKY, new PinkyFactory());
        renderableFactoryRegistry.registerFactory(RenderableType.SUPER_PELLET, new SuperPelletFactory());
